...
// ===== WiFi & ThingSpeak =====
const char* ssid = "DESKTOP-0TT3K5I 1259";
const char* password = "588F^v24";
...
const unsigned long USER_PERIOD = 120000UL;
...
bool waitForDoorClosureWithAlerting(bool &alertSent) {
  ...
  display.clearDisplay();
  display.setCursor(0,0);
  display.println("⚠️ Please close door!");
  display.display();
  digitalWrite(RED_BUZZER, HIGH);
  delay(500);
  digitalWrite(RED_BUZZER, LOW);
